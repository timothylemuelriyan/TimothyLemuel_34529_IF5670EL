...
public class PostDataAdapter extends RecyclerView.Adapter<PostDataAdapter.PostViewHolder> {
    ...
    class PostViewHolder extends RecyclerView.ViewHolder implements
            View.OnClickListener {
        public final TextView tvTitle, tvBody;
        final PostDataAdapter adapter;
        public PostViewHolder(@NonNull View itemView, PostDataAdapter
                adapter) {
            super(itemView);
    ...
    @Override
    public void onBindViewHolder(@NonNull PostViewHolder
                                         holder, int position) {
